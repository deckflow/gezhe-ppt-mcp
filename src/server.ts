...
// 可通过环境变量配置，也可通过  query string token 传递，或者 header Authorization 传递
const GEZHE_API_KEY = process.env.GEZHE_API_KEY;
...
// get auth info
const getAuthInfo = (req: express.Request): AuthInfo => {
  // query params or env
  let apiKey = (req.query.token as string) || GEZHE_API_KEY;
